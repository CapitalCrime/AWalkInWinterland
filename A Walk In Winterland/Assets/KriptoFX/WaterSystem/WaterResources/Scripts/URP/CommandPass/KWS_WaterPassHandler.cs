...
//#endif
        ...
        internal void OnBeforeCameraRendering(Camera cam, ScriptableRenderContext ctx)
        {
            try
            {
                ...
                srpRenderer.EnqueuePass(_shorelineWavesPass);
                srpRenderer.EnqueuePass(_waterPrePass);
                srpRenderer.EnqueuePass(_motionVectorsPass);
                srpRenderer.EnqueuePass(_causticPrePass);
                srpRenderer.EnqueuePass(_volumetricLightingPass);
                srpRenderer.EnqueuePass(_causticDecalPass);
                srpRenderer.EnqueuePass(_ssrPass);
                srpRenderer.EnqueuePass(_reflectionFinalPass);
                srpRenderer.EnqueuePass(_shorelineFoamPass);
                srpRenderer.EnqueuePass(_drawToDepthPass);
