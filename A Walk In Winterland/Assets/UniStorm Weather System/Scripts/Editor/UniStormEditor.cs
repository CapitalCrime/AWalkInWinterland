...
namespace UniStorm.Utility
{
    ...
    public class UniStormEditor : Editor
    {
        ...
        SerializedProperty ThunderSoundsList;
        SerializedProperty MorningSoundsList;
        SerializedProperty DaySoundsList;
        SerializedProperty EveningSoundsList;
        SerializedProperty NightSoundsList;
        SerializedProperty MorningMusicList;
        SerializedProperty DayMusicList;
        SerializedProperty EveningMusicList;
        ...
        void OnEnable()
        {
            ...
            //Thunder Sounds
            ThunderSoundsList = serializedObject.FindProperty("ThunderSounds");
            ...
            //Morning Sounds
            MorningSoundsList = serializedObject.FindProperty("MorningSounds");
            ...
            //Day Sounds
            DaySoundsList = serializedObject.FindProperty("DaySounds");
            ...
            //Evening Sounds
            EveningSoundsList = serializedObject.FindProperty("EveningSounds");
            ...
            //Night Sounds
            NightSoundsList = serializedObject.FindProperty("NightSounds");
            ...
            //Morning Music
            MorningMusicList = serializedObject.FindProperty("MorningMusic");
            ...
            //Day Music
            DayMusicList = serializedObject.FindProperty("DayMusic");
            ...
            //Evening Music
            EveningMusicList = serializedObject.FindProperty("EveningMusic");
            ...
            //Night Music
            NightMusicList = serializedObject.FindProperty("NightMusic");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (TabNumberProp.intValue == 1)
            {
                ...
                if (TimeSoundsFoldoutProp.boolValue)
                {
                    ...
                    EditorGUILayout.PropertyField(MorningSoundsList);
                    ...
                    EditorGUILayout.PropertyField(DaySoundsList);
                    ...
                    EditorGUILayout.PropertyField(EveningSoundsList);
                    ...
                    EditorGUILayout.PropertyField(NightSoundsList);
                ...
                if (TimeMusicFoldoutProp.boolValue)
                {
                    ...
                    EditorGUILayout.PropertyField(MorningMusicList);
                    ...
                    EditorGUILayout.PropertyField(DayMusicList);
                    ...
                    EditorGUILayout.PropertyField(EveningMusicList);
                    ...
                    EditorGUILayout.PropertyField(NightMusicList);
            ...
            if (TabNumberProp.intValue == 2)
            {
                ...
                if (LightningFoldoutProp.boolValue)
                {
                    ...
                    EditorGUILayout.PropertyField(ThunderSoundsList);
