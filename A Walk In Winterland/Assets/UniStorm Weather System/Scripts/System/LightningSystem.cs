...
namespace UniStorm.Utility
{
    public class LightningSystem : MonoBehaviour
    {
        ...
        [HideInInspector]
        public List<FMODUnity.EmitterRef> ThunderSounds = new List<FMODUnity.EmitterRef>();
        ...
        IEnumerator ThunderSoundDelay()
        {
            ...
            if (ThunderSounds.Count > 0)
            {
                ...
                if (m_ThunderSound.Target != null)
                {
                    FMODUnity.RuntimeManager.PlayOneShot(m_ThunderSound.Target.EventReference);
                }
            }
        }
    }
