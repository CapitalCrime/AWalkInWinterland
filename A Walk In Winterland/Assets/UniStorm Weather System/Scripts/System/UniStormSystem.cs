...
namespace UniStorm
{
    public class UniStormSystem : MonoBehaviour
    {
        ...
        public UnityEvent OnNightArriveEvent;
        public UnityEvent OnDayArriveEvent;
        ...
        //public List<FMODUnity.EmitterRef> MorningSoundRefs = new List<FMODUnity.EmitterRef>();
        ...
        [NonReorderable]public List<FMODUnity.EmitterRef> ThunderSounds = new List<FMODUnity.EmitterRef>();
        ...
        public void InitializeWeather(bool UseWeatherConditions)
        {
            ...
            if(FogType == FogTypeEnum.VolumetricFog2)
            {
                ...
                {
                    volume.settings.distantFogDistanceDensity = volumeFogRestingDistance;
                    volume.settings.density = 0;
                }
            }
        ...
        public bool isDay()
        {
            return CurrentTimeOfDay != CurrentTimeOfDayEnum.Night;
        }
        ...
        void TransitionWeather()
        {
            ...
            FogCoroutine = StartCoroutine(FogFadeSequence(50, CurrentWeatherType.FogDensity));
        ...
        IEnumerator FogFadeSequence(float TransitionTime, float MaxValue)
        {
            ...
            float currentDensity = volume.settings.distantFogDistanceDensity;
            float currentVolumetricDensity = volume.settings.density;
            ...
            while (t < 1)
            {
                ...
                switch (FogType)
                {
                    case FogTypeEnum.UnityFog:
                        ...
                        break;
                    case FogTypeEnum.VolumetricFog2:
                        volume.settings.distantFogDistanceDensity = Mathf.Clamp(Mathf.Lerp(currentDensity, CurrentWeatherType.addExtraFog ? volumeFogDistance : volumeFogRestingDistance, t * 1.1f), 0, volumeFogDistance);
                        volume.settings.density = Mathf.Clamp(Mathf.Lerp(currentVolumetricDensity, CurrentWeatherType.addExtraFog ? volumeFogVolumetricDensity : 0, t * 1.1f), 0, volumeFogVolumetricDensity);
                        break;
                    default:
                        break;
                }
